# Official JSX Blazor Server Asp.NET Core Web API Demo Applicaton of the jSilvestri.com BETA v 2024 Web API Demo Collection
...
1. **Clone the repository**:
    ...
    ```bash
    git clone https://github.com/JasonSilvestri/JsxBlazorServerCoreWebApiDemo.git
    ```

2. **Open the solution in Visual Studio**:

    - Open `JsxBlazorServerCoreWebApiDemo.sln` in Visual Studio.
